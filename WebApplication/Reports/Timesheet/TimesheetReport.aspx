<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimesheetReport.aspx.cs" Inherits="WebApplication.Reports.Timesheet.TimesheetReport" %>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-2">Percentage Threshold</label>
                        <div class="col-md-10">
                            <asp:TextBox ID="percentageThreshold" ClientIDMode="Static" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2">Hourly Rate</label>
                        <div class="col-md-10">
                            <asp:TextBox ID="hourlyRate" ClientIDMode="Static" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
